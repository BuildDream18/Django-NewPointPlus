...
from v1_terminal.buisiness_logic.access_token.update_access_token \
...
class AccessTokenUpdateTests(SimpleTestCase):
    ...
    def test_terminal_11111_success(self):
        ...
        # 発行時点での有効期限
        utc_expire_at_issue = access_token_response.access_token_expire_at
        ...
        # 更新時点での有効期限
        utc_expire_at_update = access_token_response.access_token_expire_at

        # 発行時点での有効期限 <= 更新時点での有効期限
        self.assertLessEqual(utc_expire_at_issue, utc_expire_at_update)

...
def create_access_token(mail_address, terminal_no):
    '''アクセストークンを発行する.
    ...
    access_token_payload = {"mail_address": mail_address, "terminal_no": terminal_no}
    refresh_token_payload = {"mail_address": mail_address, "terminal_no": terminal_no}
